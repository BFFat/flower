...
public class SmsDemo {
    ...
    static final String accessKeyId = "LTAI4FfL1VpAsLxSnLQCrJ1D";
    static final String accessKeySecret = "jCWg6SjvQPAGWMsUzYUwg978TY9Loe";
    ...
    public static SendSmsResponse sendSms(String phone, String code) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("Rosette");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_183267062");
...
//        request.setOutId("1725768101583464");
